$.fn.xcity = function(pName,cName,aName){
    ...
    var p = $(this).find('select[lay-com.rb.oauth.filter=province]');

    var c = $(this).find('select[lay-com.rb.oauth.filter=city]');

    var a = $(this).find('select[lay-com.rb.oauth.filter=area]');

        ...
        return this.each(function () {
            ...
            that.on('mousedown.DDSort', settings.target, function (e) {
                ...
                $doc.on('mousemove.DDSort', function (e) {
                    ...
                    let scollPosition = ScollPostion();
                    let left = e.pageX - disX - scollPosition.left,
                        top = e.pageY - disY - scollPosition.top,
                        prev = clone.prev(),
                    ...
                    top += scollPosition.top;
                    left += scollPosition.left;
                     ...
                     */
                    let thatScrollTop = that.scrollTop(),
                        thatOffsetTop = that.offset().top,
                        scrollVal;
                    console.log("滚动条：" + thatScrollTop);

...
public class PermissionRealm extends AuthorizingRealm {
    ...
    @Autowired private CmsUserService cmsUserService;
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws
        ...
        CmsUser cmsUser = cmsUserService.selectOne(wrapper);
        if (cmsUser == null || !password.equals(cmsUser.getPassword())) {
